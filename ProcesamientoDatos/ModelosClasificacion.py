...
#APLICANDO ALGORITMOS CLASE_SINIESTRO
df = df.apply(pd.to_numeric, errors='coerce')
...
#Exportamos el modelo
joblib.dump(svm_model, r'D:\SiniestrosViales\Modelos Clasificacion\svm_model_CLASE_SINIESTRO.pkl')
...
#Exportamos el modelo
joblib.dump(knn_model, r'D:\SiniestrosViales\Modelos Clasificacion\knn_model_CLASE_SINIESTRO.pkl')
...
#Exportamos el modelo
joblib.dump(rf_model, r'D:\SiniestrosViales\Modelos Clasificacion\rf_model_CLASE_SINIESTRO.pkl')



#APLICANDO ALGORITMOS CODIGO_CAUSA
df = df.apply(pd.to_numeric, errors='coerce')

for i in range(df.shape[1]):
    df[df.columns[i]] = df[df.columns[i]].fillna(0)

X = df.drop('CODIGO_CAUSA', axis=1)
y = df['CODIGO_CAUSA']
...
#Exportamos el modelo
joblib.dump(svm_model, r'D:\SiniestrosViales\Modelos Clasificacion\svm_model_CODIGO_CAUSA.pkl')
...
#Exportamos el modelo
joblib.dump(knn_model, r'D:\SiniestrosViales\Modelos Clasificacion\knn_model_CODIGO_CAUSA.pkl')
